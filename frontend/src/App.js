...
//   useEffect(() => {
//     fetch("https://events-data-anjb.onrender.com/api/events")
//       .then((res) => {
...
//     setSending(true);
//     try {
//       const res = await fetch("https://events-data-anjb.onrender.com/api/optin", {
//         method: "POST",
...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    setRegistrationError("");
    try {
      const res = await fetch("https://events-data-anjb.onrender.com/api/send-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ 
          email, 
  ...
  const verifyOTP = async (e) => {
    ...
    setRegistrationError("");
    try {
      const res = await fetch("https://events-data-anjb.onrender.com/api/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ 
          email, 
